...
import weddingLocationQR from '../../assets/Wedding_Ursa_Garden_QR_Formatted.jpg';
import receptionLocationQR from '../../assets/Reception_Prisha_Banquet_QR_Formatted.jpg';
...
export function EventTimeline() {
  ...
  return (
    <VerticalTimeline lineColor="#970747" animate={breakpoint !== 'mobile'}>
      <TimelineCard
        title="Engagement"
      ...
      <TimelineCard
        ...
        locationQR={receptionLocationQR}
